        ...
        <div className="container px-5 py-24 mx-auto flex">
          ...
          <form action="" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="relative mb-4" >
              ...
              <input type="email" id="email" name="email" className="w-full bg-white rounded border
            ...
            <div className="relative mb-4">
              ...
              <textarea id="message" name="message" className="w-full bg-white rounded border 
              border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 h-32 
              text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors
               duration-200 ease-in-out" defaultValue={""} 
